...
//    private float[] vertexArray = {
//            // Position              // Color
//            .5f, -.5f, 0f, 1f, 0f, 1f, // bottom right
//            -.5f, .5f, 0f, 0f, 1f, 0f, // top left
//            .5f, .5f, 0f, 0f, 0f, 1f, // top right
//            -.5f, -.5f, 0f, 1f, 1f, 0f, // bottom left
//    };
//    // IMPORTANT: Must be in counter-clockwise order
//    private int[] elementArray = {
//        /*
...
//        glCompileShader(vertexID);
//
//        // check for errors in compliation process
//
//        int success = glGetShaderi(vertexID, GL_COMPILE_STATUS);
//
//        if (success == GL_FALSE) {
